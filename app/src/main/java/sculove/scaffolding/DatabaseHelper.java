...
/**
 * Created by sculove on 14. 12. 26..
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<Caffeine, Integer> caffeineDao = null;
    ...
    public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
        try {
            ...
            TableUtils.createTable(connectionSource, Caffeine.class);
...
//        RuntimeExceptionDao<Caffeine, Integer> dao = getSimpleDataDao();
